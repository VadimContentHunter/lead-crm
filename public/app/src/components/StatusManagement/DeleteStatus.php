...
class DeleteStatus
{
    ...
    public function executeById(int $id): IStatusResult
    {
        ...
        try {
            ...
            if ($deletedId === null) {
                return StatusResult::failure(
                    new StatusesManagementException("Источник с ID {$id} не найден или не удалён")
                );
            }
    ...
    public function executeByTitle(string $title): IStatusResult
    {
        ...
        try {
            ...
            if ($deletedId === null) {
                return StatusResult::failure(
                    new StatusesManagementException("Источник с названием '{$title}' не найден или не удалён")
                );
            }
